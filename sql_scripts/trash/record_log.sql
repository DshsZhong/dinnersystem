...
DELIMITER $$
CREATE PROCEDURE make_log(uid INT ,func_name VARCHAR(128) ,query_detail VARCHAR(4096) ,input VARCHAR(4096) ,ip VARCHAR(128))
BEGIN
...
CALL make_log(807 ,'asdf' ,'fdas' ,'qwer' ,'0.0.0.0');
